# v1.6.7 — utility FAT Form Seed Profile Pass

This build replaces the earlier generic utility FAT placeholder with a real editable seed profile derived from the uploaded utility FAT gateway communication test form for IEC 60870-5-101/104 to IEC 61850.

## What changed

- Rebuilt `profiles/utility_utility FAT_IEC101_default_seed.json` from the utility FAT form.
...
- Added utility FAT-style test scenario metadata:
  - TSS.
