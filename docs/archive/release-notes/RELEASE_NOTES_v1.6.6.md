# Release Notes v1.6.6 — utility FAT Seed + Command Dock Pass
...
- A bundled **utility FAT IEC-101 Default Seed** is provided as a starting profile for Indonesian interoperability-style testing.
...
- `profiles/utility_utility FAT_IEC101_default_seed.json`
- `docs/profiles/utility_utility FAT_IEC101_default_seed.json`
...
- Default IOA seed is copied to output as `profiles/utility_utility FAT_IEC101_default_seed.json`.

## Known next gaps

- The utility FAT seed is a starting database, not the final official project database.
